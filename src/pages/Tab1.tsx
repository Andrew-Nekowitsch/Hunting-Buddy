...
const Icons = {
	...
	MOON: `<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 383.189 383.189" style="enable-background:new 0 0 383.189 383.189;" xml:space="preserve">
	<g>
		<g>
...
class Weather extends React.Component {
	...
	ionViewWillEnter() {
		...
		let mncon = document.getElementById("moon-container");
		if (mncon) mncon.innerHTML = Icons.MOON;
	}
